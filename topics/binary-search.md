...
| 878 | [Nth Magical Number](../solutions/0878-nth-magical-number/README.md) | `Hard` | $\mathcal{O}(\log(N \cdot \min(A, B)))$ | $\mathcal{O}(1)$ | [C++](../solutions/0878-nth-magical-number/solution.cpp) |
