...
| 730 | [Count Different Palindromic Subsequences](../solutions/0730-count-different-palindromic-subsequences/README.md) | `Hard` | $\mathcal{O}(N^2)$ | $\mathcal{O}(N^2)$ | [C++](../solutions/0730-count-different-palindromic-subsequences/solution.cpp) |
| 741 | [Cherry Pickup](../solutions/0741-cherry-pickup/README.md) | `Hard` | $\mathcal{O}(N^3)$ | $\mathcal{O}(N^2)$ | [C++](../solutions/0741-cherry-pickup/solution.cpp) |
| 801 | [Minimum Swaps To Make Sequences Increasing](../solutions/0801-minimum-swaps-to-make-sequences-increasing/README.md) | `Hard` | $\mathcal{O}(N)$ | $\mathcal{O}(1)$ | [C++](../solutions/0801-minimum-swaps-to-make-sequences-increasing/solution.cpp) |
...
| 903 | [Valid Permutations for DI Sequence](../solutions/0903-valid-permutations-for-di-sequence/README.md) | `Hard` | $\mathcal{O}(N^2)$ | $\mathcal{O}(N)$ | [C++](../solutions/0903-valid-permutations-for-di-sequence/solution.cpp) |
| 920 | [Number of Music Playlists](../solutions/0920-number-of-music-playlists/README.md) | `Hard` | $\mathcal{O}(N \cdot \text{goal})$ | $\mathcal{O}(N)$ | [C++](../solutions/0920-number-of-music-playlists/solution.cpp) |
| 940 | [Distinct Subsequences II](../solutions/0940-distinct-subsequences-ii/README.md) | `Hard` | $\mathcal{O}(N)$ | $\mathcal{O}(1)$ | [C++](../solutions/0940-distinct-subsequences-ii/solution.cpp) |
| 943 | [Find the Shortest Superstring](../solutions/0943-find-the-shortest-superstring/README.md) | `Hard` | $\mathcal{O}(N^2 \cdot 2^N)$ | $\mathcal{O}(N \cdot 2^N)$ | [C++](../solutions/0943-find-the-shortest-superstring/solution.cpp) |
| 956 | [Tallest Billboard](../solutions/0956-tallest-billboard/README.md) | `Hard` | $\mathcal{O}(N \cdot S)$ | $\mathcal{O}(S)$ | [C++](../solutions/0956-tallest-billboard/solution.cpp) |
| 960 | [Delete Columns to Make Sorted III](../solutions/0960-delete-columns-to-make-sorted-iii/README.md) | `Hard` | $\mathcal{O}(M^2 \cdot N)$ | $\mathcal{O}(M)$ | [C++](../solutions/0960-delete-columns-to-make-sorted-iii/solution.cpp) |
| 975 | [Odd Even Jump](../solutions/0975-odd-even-jump/README.md) | `Hard` | $\mathcal{O}(N \log N)$ | $\mathcal{O}(N)$ | [C++](../solutions/0975-odd-even-jump/solution.cpp) |
