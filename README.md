...
| **Binary Search** | Classic BS, Search on Answer, Rotated Arrays | 10 | [Explore Notes](topics/binary-search.md) |
| **Linked List** | Fast & Slow Pointers, Reversals, Dummy Nodes | 3 | [Explore Notes](topics/linked-list.md) |
...
| **Dynamic Programming** | 1D/2D DP, Knapsack, LCS/LIS, Interval DP, Bitmask DP | 25 | [Explore Notes](topics/dynamic-programming.md) |
...
| **Math & Geometry** | Sieve of Eratosthenes, GCD/LCM, Fast Exponentiation | 16 | [Explore Notes](topics/math-and-geometry.md) |
