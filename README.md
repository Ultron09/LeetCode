...
| :--- | :--- | :---: | :---: |
| **Arrays & Hashing** | Hash Maps, Hash Sets, Prefix Sums, Kadane's | 6 | [Explore Notes](topics/arrays-and-hashing.md) |
...
| **Stack & Queue** | Monotonic Stack, Parentheses, Min-Stack, Queues | 6 | [Explore Notes](topics/stack-and-queue.md) |
| **Binary Search** | Classic BS, Search on Answer, Rotated Arrays | 7 | [Explore Notes](topics/binary-search.md) |
...
| **Dynamic Programming** | 1D/2D DP, Knapsack, LCS/LIS, Interval DP, Bitmask DP | 21 | [Explore Notes](topics/dynamic-programming.md) |
...
| **Math & Geometry** | Sieve of Eratosthenes, GCD/LCM, Fast Exponentiation | 13 | [Explore Notes](topics/math-and-geometry.md) |
