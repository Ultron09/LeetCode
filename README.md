...
| :--- | :--- | :---: | :---: |
| **Arrays & Hashing** | Hash Maps, Hash Sets, Prefix Sums, Kadane's | 10 | [Explore Notes](topics/arrays-and-hashing.md) |
| **Two Pointers** | Opposite Ends, Same Direction, Partitioning | 2 | [Explore Notes](topics/two-pointers.md) |
| **Sliding Window** | Fixed Window, Dynamic Window, Monotonic Queue | 7 | [Explore Notes](topics/sliding-window.md) |
...
| **Heaps / Priority Queue**| Top-K Elements, Two Heaps Pattern, Merge K Lists | 7 | [Explore Notes](topics/heaps-and-priority-queues.md) |
...
| **Dynamic Programming** | 1D/2D DP, Knapsack, LCS/LIS, Interval DP, Bitmask DP | 31 | [Explore Notes](topics/dynamic-programming.md) |
...
| **Bit Manipulation** | XOR properties, Bitmasks, Power of 2 checks | 1 | [Explore Notes](topics/bit-manipulation.md) |
| **Math & Geometry** | Sieve of Eratosthenes, GCD/LCM, Fast Exponentiation | 20 | [Explore Notes](topics/math-and-geometry.md) |
