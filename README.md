...
| :--- | :--- | :---: | :---: |
| **Arrays & Hashing** | Hash Maps, Hash Sets, Prefix Sums, Kadane's | 5 | [Explore Notes](topics/arrays-and-hashing.md) |
| **Two Pointers** | Opposite Ends, Same Direction, Partitioning | 2 | [Explore Notes](topics/two-pointers.md) |
| **Sliding Window** | Fixed Window, Dynamic Window, Monotonic Queue | 2 | [Explore Notes](topics/sliding-window.md) |
| **Stack & Queue** | Monotonic Stack, Parentheses, Min-Stack, Queues | 5 | [Explore Notes](topics/stack-and-queue.md) |
...
| **Backtracking** | Permutations, Combinations, Subsets, Pruning | 4 | [Explore Notes](topics/backtracking.md) |
| **Graphs** | BFS/DFS, Dijkstra, Topo Sort, Union-Find, Bellman-Ford | 5 | [Explore Notes](topics/graphs.md) |
| **Dynamic Programming** | 1D/2D DP, Knapsack, LCS/LIS, Interval DP, Bitmask DP | 19 | [Explore Notes](topics/dynamic-programming.md) |
| **Greedy** | Activity Selection, Jump Game, Huffman Coding | 6 | [Explore Notes](topics/greedy.md) |
...
| **Math & Geometry** | Sieve of Eratosthenes, GCD/LCM, Fast Exponentiation | 11 | [Explore Notes](topics/math-and-geometry.md) |
