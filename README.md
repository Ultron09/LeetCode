...
| :--- | :--- | :---: | :---: |
| **Arrays & Hashing** | Hash Maps, Hash Sets, Prefix Sums, Kadane's | 3 | [Explore Notes](topics/arrays-and-hashing.md) |
...
| **Dynamic Programming** | 1D/2D DP, Knapsack, LCS/LIS, Interval DP, Bitmask DP | 12 | [Explore Notes](topics/dynamic-programming.md) |
...
| **Math & Geometry** | Sieve of Eratosthenes, GCD/LCM, Fast Exponentiation | 8 | [Explore Notes](topics/math-and-geometry.md) |
