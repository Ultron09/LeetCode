...
| **Sliding Window** | Fixed Window, Dynamic Window, Monotonic Queue | 1 | [Explore Notes](topics/sliding-window.md) |
| **Stack & Queue** | Monotonic Stack, Parentheses, Min-Stack, Queues | 3 | [Explore Notes](topics/stack-and-queue.md) |
...
| **Backtracking** | Permutations, Combinations, Subsets, Pruning | 3 | [Explore Notes](topics/backtracking.md) |
| **Graphs** | BFS/DFS, Dijkstra, Topo Sort, Union-Find, Bellman-Ford | 3 | [Explore Notes](topics/graphs.md) |
| **Dynamic Programming** | 1D/2D DP, Knapsack, LCS/LIS, Interval DP, Bitmask DP | 14 | [Explore Notes](topics/dynamic-programming.md) |
...
| **Math & Geometry** | Sieve of Eratosthenes, GCD/LCM, Fast Exponentiation | 10 | [Explore Notes](topics/math-and-geometry.md) |
